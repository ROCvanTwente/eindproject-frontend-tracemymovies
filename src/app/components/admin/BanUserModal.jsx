    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0B0E14]/80 backdrop-blur-sm">
      <div className="bg-[#151921] border border-[#FF61D2]/30 p-6 rounded-2xl w-full max-w-md shadow-2xl">
        ...
        <p className="text-[#94A3B8] text-sm mb-6">
          Are you sure you want to ban <span className="text-[#F8FAFC] font-semibold">{userName}</span>?
        </p>
        ...
        <div className="space-y-4">
          <div>
            ...
            <select 
              ...
              className="w-full bg-[#0B0E14] text-[#F8FAFC] p-2.5 rounded-xl border border-[#BFBCFC]/20 focus:border-[#FF61D2] focus:outline-none"
            >
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="Provide context for other admins..." 
              className="w-full bg-[#0B0E14] text-[#F8FAFC] p-2.5 rounded-xl border border-[#BFBCFC]/20 focus:border-[#FF61D2] focus:outline-none h-24 resize-none"
            />
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3 mt-8">
          ...
          <button 
            onClick={() => { 
              onBan(duration, reason, notes); 
              onClose(); 
            }} 
            className="px-5 py-2 text-sm bg-[#FF61D2] hover:bg-[#FF4DBD] text-white font-semibold rounded-lg shadow-lg shadow-[#FF61D2]/20 transition-all"
          >
            Confirm Ban
          </button>
        </div>
