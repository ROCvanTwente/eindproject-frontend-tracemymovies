    ...
    const chats = [
        {
            ...
            friendAvatar: 'SW',
            lastMessage: 'Have you seen Oppenheimer yet? Truly a masterpiece!',
            timestamp: '2 min',
            unread: 2,
            online: true,
        },
        {
            ...
            friendName: 'John Doe',
            friendAvatar: 'JD',
            lastMessage: 'Shall we go to the cinema on Friday?',
            timestamp: '1 hr',
            unread: 0,
            online: true,
        },
    ...
    const messages = [
        {
            id: 1,
            senderId: 1,
            text: 'Hey! Have you seen Dune: Part Two yet?',
            timestamp: '10:30',
        },
        {
            id: 2,
            senderId: 0,
            text: 'Yes yesterday! What a visual spectacle 🎬',
            timestamp: '10:32',
        },
        {
            id: 3,
            senderId: 1,
            text: 'I\'m going tonight! Can\'t wait',
            timestamp: '10:33',
            movieReference: {
                id: 693134,
                title: 'Dune: Part Two',
        ...
        },
        {
            id: 4,
            senderId: 0,
            text: 'You\'re going to love it! The soundtrack is amazing too',
            timestamp: '10:35',
        },
        {
            id: 5,
            senderId: 1,
            text: 'Have you seen Oppenheimer yet? Truly a masterpiece!',
            timestamp: '10:40',
        },
    ];
